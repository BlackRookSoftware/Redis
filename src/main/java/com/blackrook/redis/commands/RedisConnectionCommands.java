...
public interface RedisConnectionCommands
{
	...
	/**
	 * <p>From <a href="http://redis.io/commands/ping">http://redis.io/commands/ping</a>:
	 * <p><strong>Available since 1.0.0.</strong>
	 * <p>This command is often used to test if a connection is still alive, or to measure latency.
	...
	/**
	 * <p>From <a href="http://redis.io/commands/quit">http://redis.io/commands/quit</a>:
	 * <p><strong>Available since 1.0.0.</strong>
	 * <p>Ask the server to close the connection. The connection is closed as soon as all pending replies have been written to the client.
	 * @return always true.
	 */
	public boolean quit();

	/**
	 * <p>From <a href="http://redis.io/commands/client-getname">http://redis.io/commands/client-getname</a>:
	 * <p><strong>Available since 2.6.9.</strong>
	...
	/**
	 * <p>From <a href="http://redis.io/commands/client-setname">http://redis.io/commands/client-setname</a>:
	 * <p><strong>Available since 2.6.9.</strong>
	 * <p><strong>Time complexity:</strong> O(1)
	 * <p>The <code>CLIENT SETNAME</code> command assigns a name to the current connection.
